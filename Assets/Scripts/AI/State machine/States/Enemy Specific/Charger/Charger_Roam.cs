...
public class Charger_Roam : RoamState
{
    ...
    /// <summary>
    /// Constructor for Charger roam state
    /// </summary>
    ...
    public Charger_Roam(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_Roam stateData, Charger enemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
    ...
    {
         if(entity.GetIsInAttackAnimation()){
            return;
        }
        base.Enter();
